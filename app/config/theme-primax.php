...
return [
    ...
    'views' => [
        [
            'region'   => 'header', 
            'template' => 'primax/header', 
            'data'     => [
                'siteTitle' => "AllSpark",
                'siteTagline' => "A web template with MVC",
            ], 
            'sort'     => -1
        ],
        ['region' => 'footer', 'template' => 'primax/footer', 'data' => [], 'sort' => -1],
        [
            'region' => 'navbar',
            'template' => [
                'callback' => function() {
    ...
    'data' => [
        ...
        'title_append' => ' | Allspark',

        // Stylesheets
        'stylesheets' => ['css/allspark-primax/stylephp/style.php'],
